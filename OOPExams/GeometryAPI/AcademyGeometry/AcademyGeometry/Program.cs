                ...
                case "area":
                    {
                        ...
                        {
                            var area = (this.currentFigure as IAreaMeasurable).GetArea();
                ...
                case "volume":
                    {
                        ...
                        {
                            var volume = (this.currentFigure as IVolumeMeasurable).GetVolume();
                ...
                case "normal":
                    {
                        ...
                        {
                            var normal = (this.currentFigure as IFlat).GetNormal().ToString();
